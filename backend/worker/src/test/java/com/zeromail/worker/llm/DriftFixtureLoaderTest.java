...
class DriftFixtureLoaderTest {
    ...
    void expected_actions_only_in_allow_list() {
        assertThat(loader.loadGoldenSet())
                .allSatisfy(
                        fixture -> assertThat(ALLOWED_ACTIONS).contains(fixture.expectedAction()));
    }
    ...
    void contains_required_categories() {
        ...
        assertThat(fixtureIds)
                .anyMatch(fixtureId -> fixtureId.startsWith("html-newsletter-tracking"));
    }
    ...
    void fixtures_contain_no_real_pii_email_domains() {
        assertThat(loader.loadGoldenSet())
                .allSatisfy(
                        fixture -> {
                            String domain =
                                    fixture.from().substring(fixture.from().indexOf('@') + 1);
