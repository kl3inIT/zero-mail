...
public class TenantIsolationArchTests {
    ...
    @ArchTest
    static final ArchRule no_threadlocal =
            noClasses()
                    .that()
                    .resideInAnyPackage("..api..", "..worker..", "..core..")
                    .should()
                    .dependOnClassesThat()
    ...
    @ArchTest
    static final ArchRule fanout_via_helper =
            noClasses()
                    .that()
                    .resideOutsideOfPackage("..core.tenant.concurrency..")
                    .should()
    ...
    @ArchTest
    static final ArchRule no_native_sql =
            noClasses()
                    .that()
                    .resideOutsideOfPackage("..persistence.lowlevel..")
                    .should()
                    .callMethodWhere(
