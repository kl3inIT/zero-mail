...
class RuleEvaluatorWave0Test {
    ...
    void boolean_groups_support_all_any_and_not_semantics() throws Exception {
        ...
        Object allResult =
                evaluate(
                        evaluator,
                        Map.of("type", "ALL", "children", java.util.List.of()),
                        previewMessageFixture());
        Object anyResult =
                evaluate(
                        evaluator,
                        Map.of("type", "ANY", "children", java.util.List.of()),
                        previewMessageFixture());
        Object notResult =
                evaluate(
                        evaluator,
                        Map.of("type", "NOT", "child", Map.of("type", "HAS_ATTACHMENT")),
                        previewMessageFixture());
    ...
    void semantic_intent_returns_deferred_at_the_evaluator_level_not_only_model_construction()
        ...
        Object evaluationResult =
                evaluate(evaluator, semanticIntentMatcher, previewMessageFixture());
    ...
    private static Object newFutureEvaluator() throws Exception {
        return Class.forName("com.zeromail.core.rules.domain.RuleEvaluator")
                .getConstructor()
                .newInstance();
    }
    ...
    private static Object evaluate(Object evaluator, Object matcherAst, Object previewMessage)
        ...
        Method evaluateMethod =
                evaluator.getClass().getMethod("evaluate", Object.class, Object.class);
