...
import com.zeromail.core.rules.domain.ActionProposalMerger.ActionProposalMergeResult;
import com.zeromail.core.rules.domain.ActionProposalMerger.RuleActionCandidate;
...
class ActionProposalMergerTest {
    ...
    void duplicate_label_archive_and_save_draft_intents_dedupe_with_ordered_provenance() {
        ...
        ActionProposalMergeResult mergeResult =
                actionProposalMerger.merge(
                        List.of(
                                proposal(
                                        new ActionIntent.Label("Finance"),
                                        firstRuleId,
                                        "Receipts",
                                        "sender"),
                                proposal(
    ...
    @Test
    void
            evaluate_and_merge_uses_rule_order_and_includes_only_enabled_or_previewed_disabled_rules() {
