...
class TriageAuditRepositoryBoundaryArchTest {
    ...
    static final Set<String> ALLOWED_TRIAGE_AUDIT_MUTATION_METHODS = Set.of(
    ...
    void triage_audit_repository_exposes_only_narrow_whitelisted_mutations() throws Exception {
        ...
        assertThat(adHocMutationMethods)
                .as("triage_audit is insert-only except the explicit PENDING/APPLIED/FAILED/REVERTED transitions")
                .isEmpty();
    }
