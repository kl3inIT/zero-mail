...
public class TriageRuleEvaluationInputFactory {
  ...
  public Optional<TriageRuleEvaluationInput> fetch(
      UUID tenantId, String gmailMessageId, String gmailThreadId, java.time.Instant observedAt) {
  ...
  private static TriageRuleEvaluationInput toTriageRuleEvaluationInput(
    ...
    return new TriageRuleEvaluationInput(
        ruleEvaluationInput, previewMessage.sanitizedSenderEmail(), previewMessage.gmailThreadId());
  }

  public record TriageRuleEvaluationInput(
      RuleEvaluationInput evaluationInput, String sanitizedSenderEmail, String gmailThreadId) {}
}
