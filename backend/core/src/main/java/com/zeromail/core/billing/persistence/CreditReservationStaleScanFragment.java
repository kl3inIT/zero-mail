...
public interface CreditReservationStaleScanFragment {
    ...
    /**
     * Selects stale PENDING reservations without relying on Hibernate tenant filtering. Returned
     * rows include tenant id so the worker can bind TenantContext before release.
     */
