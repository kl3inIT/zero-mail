 ...
 *
 * <p><b>Locked membership (D-G3 + Phase 4 D-E1):</b> {@code TRIAGE}, {@code DRAFT},
 * {@code PREVIEW}, {@code TRIAGE_PLATFORM_LLM}, {@code TRIAGE_DETERMINISTIC}. There is
 * intentionally no BYOK member because BYOK traffic bypasses the ledger entirely. The ledger
 * service contract documents the BYOK skip path.
 *
