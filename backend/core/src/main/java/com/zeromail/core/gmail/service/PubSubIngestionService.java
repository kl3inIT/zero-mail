 ...
 *
 * <p>Controllers never inject repositories; this service is the boundary for unscoped tenant lookup
 * plus tenant-bound pubsub_delivery INSERT.
 */
@Service
public class PubSubIngestionService {
     ...
     * Ack-fast ingestion.
     *
     * <p>Tenant lookup is intentionally unscoped native SQL because Gmail email lookup happens
     * before a tenant is known. The tenant-bound INSERT transaction opens only after TenantContext
     * is bound, preserving the Hibernate tenant invariant.
     */
