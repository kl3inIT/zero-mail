 ...
 * encrypted at the app layer through the inbox projection cipher; the sender hash column is a
 * keyed HMAC for future deterministic lookup without exposing plaintext.
 *
 ...
 * sent-message projection, Gmail {@code history.list} incremental sync, cron purge of expired
 * rows. {@code mail_message_observed} remains the append-once ingestion/triage seed; this module
 * is the mutable display projection beside it, not a replacement.
 */
