 ...
 *
 * <p><b>Privacy invariant (SPEC OPS-QUEUE-01/02 + T-08-45):</b> this record deliberately omits any
 * payload/body field. The DTO contract IS the gate — {@code QueueHealthQueryServiceSqlSpyTest}
 * additionally asserts the emitted SQL never selects {@code payload_json}, and {@code
 * AdminPathBodyBanTest} rejects forbidden field names.
 *
