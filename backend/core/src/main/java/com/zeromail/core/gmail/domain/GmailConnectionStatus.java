...
/**
 * Gmail connection lifecycle states. Implements {@link IdentifiedEnum} only — these states are
 * unordered (PENDING is not "less than" CONNECTED in any sortable sense), so per D-B5 we do NOT
 * extend {@link com.zeromail.core.shared.lang.OrderedEnum}.
 *
                ...
                .orElseThrow(
                        () ->
                                new NoSuchElementException(
                                        "Unknown GmailConnectionStatus id: " + id));
    }
}
