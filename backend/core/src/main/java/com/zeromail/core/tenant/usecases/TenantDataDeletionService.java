...
public class TenantDataDeletionService {
    ...
    private static final List<TenantOwnedTable> DELETION_PATH =
            List.of(
                    ...
                    new TenantOwnedTable("messaging_conversation_session", "tenant_id"),
                    new TenantOwnedTable("messaging_conversation", "tenant_id"),
                    new TenantOwnedTable("messaging_channel_account", "tenant_id"),
