...
public class MailMessageObservedEntity {
    ...
    public MailMessageObservedEntity(UUID tenantId, String gmailMessageId, String gmailThreadId,
        ...
        this(tenantId, gmailMessageId, gmailThreadId, historyId, labelIds, internalDate, Instant.now());
    }

    public MailMessageObservedEntity(UUID tenantId, String gmailMessageId, String gmailThreadId,
                                     Long historyId, String[] labelIds, Long internalDate, Instant observedAt) {
