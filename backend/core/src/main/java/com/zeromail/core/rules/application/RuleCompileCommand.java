  ...
  public RuleCompileCommand {
    ...
    clarificationAnswer =
        normalizeOptionalText(
            clarificationAnswer, "clarificationAnswer", MAX_CLARIFICATION_ANSWER_LENGTH);
    priorCompileContext =
        normalizeOptionalText(priorCompileContext, "priorCompileContext", MAX_PRIOR_CONTEXT_LENGTH);
  }
