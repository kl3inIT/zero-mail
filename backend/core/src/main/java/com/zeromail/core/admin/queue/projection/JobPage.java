...
/**
 * Paginated unified job list. Same opaque-cursor idiom as {@link DeadLetterPage}: offset-encoded
 * cursor string + has-next flag + an estimated total for the dashboard.
 */
