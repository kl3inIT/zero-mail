...
public class TriageGmailWriter {
  ...
  public void applyLabel(UUID tenantId, String gmailMessageId, String labelId) throws IOException {
    executeGmailWrite(
        tenantId,
        "applyLabel",
        gmail -> {
        ...
        gmail -> {
          gmail
              ...
              .modify(
                  USER_ID,
                  gmailMessageId,
                  new ModifyMessageRequest().setRemoveLabelIds(List.of(INBOX_LABEL_ID)))
              .execute();
        ...
        gmail -> {
          Draft createdDraft =
              gmail
                  ...
                  .create(
                      USER_ID,
                      new Draft().setMessage(draftMessage(draftSpec.instruction(), gmailThreadId)))
                  .execute();
  ...
  public void removeLabel(UUID tenantId, String gmailMessageId, String labelId) throws IOException {
    executeGmailWrite(
        tenantId,
        "removeLabel",
        gmail -> {
        ...
        gmail -> {
          gmail
              ...
              .modify(
                  USER_ID,
                  gmailMessageId,
                  new ModifyMessageRequest().setAddLabelIds(List.of(INBOX_LABEL_ID)))
              .execute();
