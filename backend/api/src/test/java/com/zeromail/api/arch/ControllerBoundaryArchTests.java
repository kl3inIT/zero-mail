 ...
 * Tenant-sensitive flows (account, onboarding, Gmail connection state) belong inside
 * application services where transaction boundaries and tenant invariants live in one place.
 *
 * <p>Repository / entity access from {@code ..api.controllers..} is forbidden — controllers
 * stay transport-only and delegate to {@code ..core.account..} (or future service modules).
 */
...
public class ControllerBoundaryArchTests {
    ...
    static final ArchRule controllers_do_not_touch_repositories =
            noClasses()
                    ...
                    .because("WR-01: controllers must delegate to application services, "
