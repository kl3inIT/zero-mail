 ...
 * and the intent must end up in {@code PAID}. The atomic conditional UPDATE on
 * {@code billing_topup_intent.status} is what makes this safe; this test pins the contract.
 */
@ActiveProfiles("test")
