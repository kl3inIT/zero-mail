 ...
 *
 * <p>This test only covers the happy-path log scrub. The mismatch path, where D-I1
 * explicitly permits {@code event=sepay_webhook_amount_mismatch intentVnd={} actualVnd={}}
 * with numbers, is covered by {@link SepayWebhookMismatchAuditEventTest}. Do NOT extend
 * this scrub test to assert against numeric amounts in the mismatch path; that contradicts
 * the locked privacy contract.
 */
@ActiveProfiles("test")
