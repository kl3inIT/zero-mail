...
public record MeResponse(
  ...
  public static MeResponse from(
      CurrentUserProjection user, boolean triagePaused, GmailConnectionStatusExtended gmailStatus) {
  ...
  public static MeResponse from(
      CurrentUserProjection user, boolean triagePaused, GmailConnectionProjection gmailConnection) {
    return from(
        user,
        triagePaused,
