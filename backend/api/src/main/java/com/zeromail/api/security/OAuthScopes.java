 ...
 * Mirrors the {@code ErrorCodes.java} shape: {@code public final class} + private ctor +
 * {@code public static final String} constants. Eliminates scope-string duplication across
 * the success handler, resolver, and tests (REVIEW §5 finding).
 */
