...
| *(No `spring-cloud-gcp` starter by default)* | Secrets are supplied through VPS deployment secrets (Docker secrets, systemd credentials, or locked-down env files). |
### Spring AI Modules
