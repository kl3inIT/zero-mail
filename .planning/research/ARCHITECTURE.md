...
- HIGH on the Spring AI `2.0.0-M6` adapter seams confirmed during Phase 2C (`OpenAiChatModel.builder().options(...)`, `ChatClient.prompt().options(builder)`, provider-specific BYOK model selection)
