...
- [x] 08.1-06-PLAN.md — Runtime outbound execution: shared `OutboundSendGateway`, fallback-to-draft gates, ArchUnit/privacy tests, safe Gmail UAT (live-send UAT deferred to external tenant)
...
| 08.1. Inbox Zero-style Rule Actions & Admin-managed Examples Catalog | v1.2 | 6/6 | Complete | 2026-05-25 |
