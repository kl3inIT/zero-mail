...
- [x] **CAL-TRIAGE-02**: Calendar-class messages are pinned at top-of-inbox in the web UI for a 24-hour window after the event date, with explicit "Cancellation" / "Time changed" badges. _(Closed in Phase 12 G1: backend wiring + build.gradle.kts emit fix + schema.d.ts regen + Vitest/Playwright proof committed 2026-06-23.)_
