...
- [x] **WEB-02**: UI covers onboarding, rule CRUD with live preview, triage audit log with undo, draft review, analytics, and billing — 5A portion done (onboarding, rules+live-preview, triage audit log+undo, billing); 5B draft-review done and `GET /api/triage/audit` built; analytics remains → 5C
