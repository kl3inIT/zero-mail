// Wave 0 RED scaffold — locks the token parity contract (Phase 1.6 REQ-1.6-1):
//  - Every supplemental token has --color-{name}: var(--{name}) in @theme inline
//  - --accent is #0E5E5A in :root
//  - --accent is #6FB3A8 in .dark
//
// RED-by-design: globals.css does not yet define supplemental tokens or the correct
// accent values. This spec becomes GREEN when Phase 1.6 Wave 1 lands.
