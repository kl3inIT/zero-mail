...
export interface paths {
    ...
    "/api/gmail/active-mailbox/{gmailConnectionId}": {
        ...
        get?: never;
        put: operations["setActiveMailbox"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/api/unsubscribe/senders/action": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/integrations/telegram/pairing": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/gmail/mailboxes/{gmailConnectionId}/set-primary": {
        ...
        get?: never;
        put?: never;
        post: operations["setPrimaryFromValidationRoute"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/gmail/mailboxes/{gmailConnectionId}/reconnect": {
        ...
        get: operations["reconnect"];
        put?: never;
        post: operations["reconnectFromValidationRoute"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/gmail/mailboxes/{gmailConnectionId}/primary": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/gmail/mailboxes/{gmailConnectionId}/disconnect": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/admin/queue/jobs/{jobId}/force-retry": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/admin/queue/jobs/{jobId}/cancel": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/admin/catalog/models/enable": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/unsubscribe/stats/messages": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/unsubscribe/stats/messages/{gmailMessageId}/body": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/gmail/inbox/threads/{gmailThreadId}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/integrations/telegram/connection": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
...
export interface components {
    schemas: {
        ...
        ComposerDraftUpsertRequestDto: {
            gmailThreadId: string;
            /** @description Gmail draftId of the existing draft for this thread, if the client already knows it. When present the backend updates that draft directly instead of scanning Gmail, which avoids the create-create race that flooded the user's drafts folder with duplicates. */
            draftId?: string;
        ...
        CleanupSenderActionRequest: {
            /** @enum {string} */
            action: "APPROVE" | "UNAPPROVE" | "MARK_UNSUBSCRIBED" | "AUTO_ARCHIVE" | "ARCHIVE" | "DELETE" | "LABEL_FUTURE";
            senderEmails: string[];
            labelName?: string;
        };
        ...
        BillingPlanListResponse: {
            /**
             * @description Tenant's currently-active plan code. Falls back to FREE when no active paid plan period exists.
             * @enum {string}
             */
        ...
        MailboxSummaryResponse: {
            ...
            ingestionHealth: string;
            /** Format: int64 */
            lastSyncedHistoryId?: number | null;
            /** Format: date-time */
        ...
        GmailInboxPageResponse: {
            ...
            maxMessages: number;
            /**
             * @description Source of this page. PROJECTION = DB-backed inbox projection; LIVE_GMAIL = live Gmail metadata fallback; SYNCING = backfill in flight, items is empty, render a syncing banner.
             * @enum {string}
             */
            dataSource: "PROJECTION" | "LIVE_GMAIL" | "SYNCING";
        };
        ...
        GmailThreadDetailResponse: {
            gmailThreadId: string;
            subject: string;
            messages: components["schemas"]["GmailInboxMessageDetailResponse"][];
        };
        ...
        AnalyticsSummaryResponse: {
            ...
            topRecipients: components["schemas"]["EmailAddressLoadResponse"][];
        ...
        QueueHealthResponse: {
            ...
            /**
             * Format: int32
             * @description FAILED rows in the last 24h (numerator of failureRateLast24h). Pair with sampleSizeLast24h to render an honest count when the sample is too small for a meaningful percentage.
             */
            failedCountLast24h: number;
            /**
             * Format: int32
             * @description Rows created in the last 24h (denominator of failureRateLast24h). When small (e.g. < 10) the client should show counts, not a percentage — 1/1 = 100% alarms without informing.
             */
        ...
        FeedbackListResponse: {
            rows: components["schemas"]["FeedbackRowResponse"][];
            /** Format: int64 */
            openCount: number;
        };
        FeedbackRowResponse: {
...
export interface operations {
    ...
    setActiveMailbox: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["ActiveMailboxResponse"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    find: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["ComposerDraftResponseDto"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    upsert: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ComposerDraftUpsertRequestDto"];
            };
        };
        responses: {
            /** @description OK */
    ...
    action: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CleanupSenderActionRequest"];
            };
        };
        responses: {
            ...
            202: {
                ...
                content: {
                    "*/*": components["schemas"]["CleanupSenderActionResponse"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    submitFeedback: {
        ...
        responses: {
            ...
            201: {
                ...
                content: {
                    "*/*": components["schemas"]["FeedbackSubmissionResponse"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    copyRules: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["CopyRulesResponse"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    pairing: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["TelegramPairingResponse"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    enableModel: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CatalogModelEnableRequest"];
            };
        };
        responses: {
            /** @description No Content */
    ...
    timeline: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["SenderTimelineEntryResponse"][];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    messages: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["SenderMessageSummaryResponse"][];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    messageBody: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["SenderMessageBodyResponse"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    listMailboxes: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["MailboxSummaryResponse"][];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    threadDetail: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["GmailThreadDetailResponse"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    schedulers: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["SchedulerResponse"][];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    jobs: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["JobPageResponse"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    list_11: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["FeedbackListResponse"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    disconnect_3: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["TelegramDisconnectResponse"];
                };
            };
            /** @description Bad Request */
            400: {
