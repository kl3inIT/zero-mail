  ...
  return (
    <div className="space-y-6 p-4 sm:p-6">
          ...
          <CardContent>
            {currentUser.isPending ? (
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  {connected ? t('shell.connection.connected') : t('shell.connection.disconnected')}
                </span>
              </div>
            )}
          </CardContent>
      ...
      <div className="space-y-3">
        <h2 className="text-foreground text-base font-semibold">{t('dashboard.recentActivity')}</h2>
        <AuditLog />
      </div>
    </div>
  );
