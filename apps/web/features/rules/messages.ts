export const rulesMessages = {
  ...
  'rules.page.intro': {
    vi: 'Viết quy tắc bằng ngôn ngữ tự nhiên, xem trước thư nào sẽ khớp, rồi chỉ bật các quy tắc bạn tin tưởng.',
    en: 'Write rules in plain language, preview what would match, then enable only the rules you trust.',
  },
  'rules.page.safetyNote': {
    vi: 'Quy tắc mới luôn được lưu ở trạng thái tắt. Chạy thử không thay đổi Gmail.',
    en: 'New rules are saved disabled. Preview never changes Gmail.',
  },
  'rules.list.title': {
    vi: 'Thứ tự quy tắc',
    en: 'Rule order',
  ...
  'rules.list.empty.body': {
    vi: 'Viết quy tắc đầu tiên hoặc bắt đầu từ template Gmail. Quy tắc mới luôn tắt cho đến khi bạn chạy thử.',
  ...
  'rules.list.previewReady': {
    vi: 'Đã chạy thử',
    en: 'Previewed',
  },
  'rules.list.previewRequired': {
    vi: 'Cần chạy thử',
    en: 'Preview required',
  },
  'rules.list.moveUp': {
    vi: 'Di chuyển quy tắc lên',
    en: 'Move rule up',
  },
  'rules.list.moveDown': {
    vi: 'Di chuyển quy tắc xuống',
    en: 'Move rule down',
  },
  'rules.list.edit': {
    vi: 'Sửa quy tắc',
  ...
  'rules.composer.answerClarification': {
    vi: 'Trả lời câu hỏi làm rõ',
    en: 'Answer clarification',
  },
  'rules.composer.answerLabel': {
    vi: 'Câu trả lời làm rõ',
    en: 'Clarification answer',
  },
  'rules.composer.compiledReview': {
    vi: 'Zero Mail đã hiểu',
    en: 'What Zero Mail understood',
  },
  ...
  'rules.preview.empty.body': {
    vi: 'Chạy thử trên các email Gmail gần đây trước khi bật quy tắc này.',
    en: 'Run a preview against recent Gmail messages before enabling this rule.',
  },
  ...
  'rules.preview.deferredSemantic': {
    vi: 'Kiểm tra ngữ nghĩa trì hoãn',
  ...
  'errors.rules.compile.invalid': {
    vi: 'Zero Mail không thể biên dịch quy tắc này. Hãy sửa cách diễn đạt hoặc trả lời câu hỏi làm rõ rồi biên dịch lại.',
    en: 'Zero Mail could not compile this rule. Edit the wording or answer the clarification, then compile again.',
  },
  ...
  'errors.rules.insufficientCredits': {
    vi: 'Tín dụng nền tảng đã hết. Hãy nạp thêm tín dụng hoặc lưu khóa BYOK hợp lệ trước khi biên dịch hoặc chạy thử quy tắc.',
    en: 'Platform credits are depleted. Top up credits or save a valid BYOK key before compiling or previewing rules.',
  },
